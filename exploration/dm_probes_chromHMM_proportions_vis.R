...
probe_sets <- list(
  hyper_refCFN_compCUB = readLines(paste0(probe_dir, "/probe_set_hyper_refCFN_compCUB.txt")),
  hypo_refCFN_compCUB = readLines(paste0(probe_dir, "/probe_set_hypo_refCFN_compCUB.txt")),
...
colnames(df) <- c("CFNvsCUB.hyper", "CFNvsCUB.hypo", "ANvsTU.hyper", "ANvsTU.hypo")
