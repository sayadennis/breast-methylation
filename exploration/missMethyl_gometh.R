...
tf_probes <- list(
  "TFBS_CFN_vs_CUB_only" = setdiff(left_probes_tf_all, right_probes_tf_all),
  "TFBS_AN_vs_TU_only" = setdiff(right_probes_tf_all, left_probes_tf_all),
  "TFBS_CFNvCUB_ANvTU_overlap" = intersect(left_probes_tf_all, right_probes_tf_all)
)
