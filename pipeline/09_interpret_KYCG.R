...
cts <- data.frame(matrix(
  c(
    # hypo in CUB and TU
    "hypo", "hypo", "refHDB_compCUB", "refAN_compTU", "ZNF217", 0, 0, 0, 0, 0., 0., 0.,
    "hypo", "hypo", "refHDB_compCUB", "refAN_compTU", "AHR", 0, 0, 0, 0, 0., 0., 0.,
    "hypo", "hypo", "refHDB_compCUB", "refAN_compTU", "TLE3", 0, 0, 0, 0, 0., 0., 0.,
    "hypo", "hypo", "refHDB_compCUB", "refAN_compTU", "GREB1", 0, 0, 0, 0, 0., 0., 0.,
    "hypo", "hypo", "refHDB_compCUB", "refAN_compTU", "GRHL2", 0, 0, 0, 0, 0., 0., 0.,
    "hypo", "hypo", "refHDB_compCUB", "refAN_compTU", "ESR1", 0, 0, 0, 0, 0., 0., 0.,
    "hypo", "hypo", "refHDB_compCUB", "refAN_compTU", "PR", 0, 0, 0, 0, 0., 0., 0.,
    "hypo", "hypo", "refHDB_compCUB", "refAN_compTU", "FOSL2", 0, 0, 0, 0, 0., 0., 0.,
    "hypo", "hypo", "refHDB_compCUB", "refAN_compTU", "AR", 0, 0, 0, 0, 0., 0., 0.,
    "hypo", "hypo", "refHDB_compCUB", "refAN_compTU", "GATA3", 0, 0, 0, 0, 0., 0., 0.,
    "hypo", "hypo", "refHDB_compCUB", "refAN_compTU", "NR3C1", 0, 0, 0, 0, 0., 0., 0.,
    "hypo", "hypo", "refHDB_compCUB", "refAN_compTU", "HES2", 0, 0, 0, 0, 0., 0., 0.,
    # hyper in AN and TU
    ...
    "hypo", "hyper", "refHDB_compCUB", "refAN_compTU", "TEAD1", 0, 0, 0, 0, 0., 0., 0.
  ),
  ncol = length(cols),
  byrow = TRUE
))
